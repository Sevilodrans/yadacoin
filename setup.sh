...
sudo bash -c "cat > /etc/yadacoin/READ_ME" << EOL
...
This will display the config.json file in the terminal and you will find your 'wif'.
The 'wif' will be on line 13 of the file:
        "wif": "xXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxXxX",
Copy this number and at https://yadacoin.io/app enter the 'wif' into the "Import Identity" field
...
somewhere safe as this is where the rewards of your mining will be sent.
...
To read this file again, it can be found here - /etc/yadacoin/READ_ME
cat /etc/yadacoin/READ_ME will display the test easily

Join our discord for help, news, and further information!
https://discord.gg/JEDJaFS
EOL

# Display the READ_ME file in the terminal post installation
cat /etc/yadacoin/READ_ME | more
